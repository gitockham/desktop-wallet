export default {
  COMMON: {
    ADDRESS: 'Adresse',
    ALL: 'Tout',
    APP_NAME: 'Portfeuille Local Ockham',
    APP_NAME_SHORT: 'Bureau Ockham',
    ...
    DELEGATE: 'Délégué',
    DONE: 'Fait',
    FAILED_FETCH: 'Échec de l\'extraction de {nom}. Raison : "{msg}".',
    FETCH: 'Chercher',
    FINISH: 'Terminer',
    IS_MARKET_CHART_ENABLED: 'Graphique sur le tableau de bord',
    LANGUAGE: 'Langue de l\'application',
    LEDGER: 'Grand livre',
    LEDGER_WALLET: 'Ceci est un portefeuille',
    NETWORK: 'Réseau',
  ...
  INTRODUCTION: {
    ...
    DUTY: {
      ...
      WARNING: {
        ...
        CANNOT_RESTORE: 'Les mots de passe, phrases secrètes ou fonds volés perdus ne peuvent pas être restaurés par les délégués, l\'équipe OCKHAM CONSULTING ou toute autre personne.'
      },
    ...
    RESPONSIBILITY: {
      ...
      STORAGE: {
        EXPLANATION: 'The {PASSPHRASE} of each wallet address is able to sign transactions and move funds. This means if your computer dies but you have your passphrase, you can still access your funds. The Ockham Desktop Wallet has an additional feature that lets you set an {ENCRYPTED} as well, for easier management. If your computer dies, you cannot use the encrypted password to access your funds from a different machine. {NEED}.',
    ...
    TURN: {
      TITLE: 'A votre tour',
      KNOWLEDGE: 'Maintenant, sachant à quel point il est important de protéger vos phrases secrètes, vous êtes prêt à revendiquer votre autonomie financière avec le portefeuille de bureau OCKHAM.',
      SUPPORT: 'OCKHAM est un écosystème open-source. Si vous avez besoin d\'aide, la communauté OCKHAM et son équipe sont à votre disposition. Créez un post sur reddit.ockham.consulting ou rejoignez le système de discussion en temps réel à l\'adresse slack.ark.io.',
      CONCLUSION: 'Tous les membres de l\'équipe OCKHAM CONSULTING espèrent que vous apprécierez l\'utilisation du portefeuille Ockham Desktop Wallet pour participer à la révolution de la blockchain !'
    }
  },
  ...
  APP_FOOTER: {
    TEXT: 'Fabriqué avec ♥ par Ockham Consulting Institute'
  },
  ...
  PAGES: {
    ...
    PROFILE_NEW: {
      ...
      STEP3: {
        ...
        MARKET_CHART: 'Choisissez d\'afficher ou non le tableau de prix sur le tableau de bord',
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Achetez {ticker} directement dans le portefeuille OCKHAM Desktop avec notre intégration Changelly',
  ...
  WALLET_HEADING: {
    ACTIONS: {
      ...
      DELETE_WALLET: 'Supprimer le portfefeuille',
