...
const releaseApiUrl = 'https://api.github.com/repos/gitockham/ock-desktop-wallet/releases/latest'
const releaseUrl = 'https://github.com/gitockham/ock-desktop-wallet/releases/latest'
